...
app = FastAPI(
    title="Veyrion — Skin Lesion Decision Support API",
    version=__version__,
    description="Veyrion: Multi-backbone feature-fusion skin lesion classifier (HAM10000, 7 classes). "
                "Precision in Every Insight. Decision-support only — not a diagnostic device.",
)
...
@app.get("/")
def root():
    return {"service": "Veyrion inference", "version": __version__, "docs": "/docs"}
